...
export default function Analytics() {
  ...
  return (
    <>
      {/* Google Tag Manager (loads GA4). lazyOnload: GTM's ~125KB is deferred
          until the page is idle so it doesn't compete with the LCP image for
          bandwidth/main-thread. Pageviews still fire, just a moment later. */}
